...
DEFINE_LIST(FS_Buffer_Dirty_List, FS_Buffer_Dirty);

/* wrapper for dirty buffer list */
struct FS_Buffer_Dirty {
	ulong_t fsBlockNum;
	DEFINE_LINK(FS_Buffer_Dirty_List, FS_Buffer_Dirty);
};
...
IMPLEMENT_LIST(FS_Buffer_Dirty_List, FS_Buffer_Dirty);
