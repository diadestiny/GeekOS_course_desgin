...
#define PAGING_DEFAULT                0        /* evict the oldest page */
#define PAGING_WSCLOCK                1        /* working set clock algorithm */

extern int g_currentPagingAlgorithm;        /* currently used paging algorithm */

#define PAGE_CLEARING_CYCLE        1        /* in clock ticks */
#define WORKING_SET_TIMEOUT        5        /* in clearing cycles */
extern ulong_t g_WorkingSet_Timeout;        /* maximum page age in working set */
...
extern pde_t* g_dir;                        /* global pointer for kernel page directory */
